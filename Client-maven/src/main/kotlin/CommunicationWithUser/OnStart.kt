package CommunicationWithUser
import HelpingOrFormatingClasses.printResults
import java.io.File
...
fun getPathToCollection() : String{
    printResults("Please enter the absolute path to the file.json with collection: (Data.json)")
